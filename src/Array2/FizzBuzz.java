...
public class FizzBuzz {
    ...
    and for multiples of both 3 and 5 use "FizzBuzz". In Java, String.valueOf(xxx) will make
    the String form of an int or other type. This version is a little more complicated than
    ...
    public FizzBuzz(int start, int end) {
        this.start = start;
        this.end = end;
        System.out.println("FizzBuzz: " + Arrays.toString(create()));
    }
